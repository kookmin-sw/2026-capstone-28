...
export default function ProfilePage({ onNavigate }) {
  ...
  const handleUpdateProfile = async ({ currentPassword, username }) => {
    ...
    try {
      ...
      setUserProfile((prev) => ({ ...prev, username: trimmedUsername }));
      alert("회원정보가 수정되었습니다.");
      setEditModalType(null);
    } catch (err) {
    ...
    <div style={styles.root}>
      ...
      <main style={{
        ...
        <aside style={styles.leftColumn}>
          ...
          <div style={{
            ...styles.profileCard,
            ...(isMobile ? { padding: "28px 20px 24px", borderRadius: 22 } : {}),
          }}>
...
const HistoryCard = ({ item, isMobile, onDetail, onDelete }) => (
  <div style={{
    ...styles.historyCard,
    ...
    <div style={{
      ...
      <div style={{
        ...styles.thumbColumn,
        ...(isMobile ? { flexDirection: "row", gap: 10 } : {}),
      }}>
...
/* ---------- Account Edit Modal ---------- */
const AccountEditModal = ({ type, userProfile, loading, isMobile, onClose, onSubmit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    onSubmit({ currentPassword, username, newPassword, newPasswordConfirm });
  };

  return (
    <div style={styles.modalOverlay} onClick={onClose}>
      <form style={{
        ...styles.accountModalCard,
        ...(isMobile ? {
          maxWidth: "95vw",
...
/* ---------- Detail Modal ---------- */
const DetailModal = ({ item, isMobile, onClose }) => {
  ...
  return (
    <div style={styles.modalOverlay} onClick={onClose}>
      <div style={{
        ...
        <div style={{
          ...styles.modalHeader,
          ...(isMobile ? { flexDirection: "column", alignItems: "center", gap: 16 } : {}),
        }}>
          <div style={{
...
const styles = {
  ...
  main: {
    position: "relative", zIndex: 1, padding: "120px 8% 60px 12%",
    display: "grid", gridTemplateColumns: "360px minmax(0, 720px)",
  ...
  profileCard: {
    position: "relative", zIndex: 1, padding: "36px 32px 32px", borderRadius: 28,
    background: "linear-gradient(155deg, rgba(255,255,255,0.7) 0%, rgba(255,255,255,0.4) 50%, rgba(200,242,220,0.3) 100%)",
    backdropFilter: "blur(36px) saturate(180%)",
    WebkitBackdropFilter: "blur(36px) saturate(180%)",
    border: "1px solid rgba(255,255,255,0.8)",
    boxShadow: [
      "0 30px 80px rgba(11,59,46,0.2)", "0 8px 24px rgba(11,59,46,0.08)",
      "inset 0 1px 0 rgba(255,255,255,0.95)", "inset 0 -1px 0 rgba(46,139,87,0.12)",
    ].join(", "),
    overflow: "hidden",
  },
  ...
  profileHeader: { display: "flex", alignItems: "center", gap: 18 },
  avatar: {
  ...
  userName: {
    ...
    color: C.deep, letterSpacing: -0.5,
  },
  ...
  infoRow: { display: "flex", alignItems: "center", gap: 14, marginBottom: 18 },
  infoIcon: {
  ...
  actionBtn: {
    ...
    color: C.deep, fontFamily: "'Rajdhani',sans-serif", fontSize: 13, fontWeight: 700,
    cursor: "pointer",
  ...
  titleAccent: {
    width: 4, height: 30, borderRadius: 4,
  ...
  countBadge: {
    ...
    background: "linear-gradient(135deg, rgba(200,242,220,0.9), rgba(127,227,181,0.5))",
    border: "1px solid rgba(255,255,255,0.8)",
    color: C.forest, fontSize: 12, fontWeight: 700, letterSpacing: 0.5,
    boxShadow: "0 2px 8px rgba(46,139,87,0.15)",
  },
  historyList: { display: "flex", flexDirection: "column", gap: 18 },
  loadingWrap: {
    display: "flex", flexDirection: "column",
    alignItems: "center", justifyContent: "center",
  ...
  loadingSpinner: {
    ...
    border: `3px solid rgba(46,139,87,0.2)`, borderTopColor: C.emerald,
  ...
  historyCardPending: { opacity: 0.75, border: `1px dashed rgba(46,139,87,0.4)` },
  pendingBadge: {
  ...
  historyCard: {
    position: "relative", padding: "24px 26px", borderRadius: 22,
    background: "linear-gradient(155deg, rgba(255,255,255,0.65) 0%, rgba(255,255,255,0.4) 50%, rgba(200,242,220,0.3) 100%)",
    backdropFilter: "blur(28px) saturate(170%)",
    WebkitBackdropFilter: "blur(28px) saturate(170%)",
    border: "1px solid rgba(255,255,255,0.8)",
    boxShadow: [
      "0 18px 50px rgba(11,59,46,0.15)", "0 6px 18px rgba(11,59,46,0.06)",
      "inset 0 1px 0 rgba(255,255,255,0.95)", "inset 0 -1px 0 rgba(46,139,87,0.1)",
    ].join(", "),
    overflow: "hidden", transition: "transform 0.2s",
  },
  historyTop: { display: "flex", gap: 24, alignItems: "flex-start" },
  historyTextSide: { flex: 1, minWidth: 0 },
  historyCardTitle: {
    fontFamily: "'Chakra Petch',sans-serif", fontSize: 18, fontWeight: 700,
    color: C.deep, margin: 0, letterSpacing: -0.3,
  },
  historyDate: { fontSize: 12, color: C.textSoft, margin: "8px 0 12px" },
  ...
  featureBadge: {
    ...
    border: "1px solid rgba(255,255,255,0.8)",
    color: C.forest, fontSize: 12, fontWeight: 600,
  },
  summary: { fontSize: 13, color: C.textSoft, lineHeight: 1.6, margin: 0 },
  thumbColumn: { display: "flex", flexDirection: "column", gap: 10, flexShrink: 0 },
  thumbBox: {
    position: "relative", width: 130, height: 78, borderRadius: 12, overflow: "hidden",
    border: "1px solid rgba(255,255,255,0.85)",
  ...
  progressTrack: {
    height: 5, borderRadius: 999, background: "rgba(46,139,87,0.15)",
    overflow: "hidden", marginTop: 18,
  },
  progressFill: {
    height: "100%",
    background: `linear-gradient(90deg,${C.forest},${C.emerald},${C.mint})`,
    borderRadius: 999, boxShadow: `0 0 12px ${C.mint}`,
  },
  cardFooter: {
  ...
  footerBtnGroup: { display: "flex", gap: 8, alignItems: "center" },
  deleteBtn: {
    padding: "8px 16px", borderRadius: 999,
    border: "1px solid rgba(180,60,60,0.25)",
    background: "linear-gradient(135deg, rgba(255,255,255,0.65), rgba(255,230,230,0.45))",
    color: "#8A2D2D", fontFamily: "'Rajdhani',sans-serif", fontSize: 12, fontWeight: 700,
    cursor: "pointer",
  ...
  detailBtn: {
    ...
    border: "1px solid rgba(255,255,255,0.85)",
    background: "linear-gradient(135deg, rgba(255,255,255,0.65), rgba(255,255,255,0.3))",
    color: C.forest, fontFamily: "'Rajdhani',sans-serif", fontSize: 12, fontWeight: 700,
    cursor: "pointer",
    boxShadow: "0 4px 12px rgba(11,59,46,0.06), inset 0 1px 0 rgba(255,255,255,0.9)",
  },
  accountModalCard: {
    position: "relative", width: "100%", maxWidth: 480, padding: "40px 44px 32px",
    borderRadius: 32,
    background: "linear-gradient(155deg, rgba(255,255,255,0.86) 0%, rgba(255,255,255,0.6) 50%, rgba(200,242,220,0.4) 100%)",
    backdropFilter: "blur(40px) saturate(200%)",
    WebkitBackdropFilter: "blur(40px) saturate(200%)",
    border: "1px solid rgba(255,255,255,0.85)",
    boxShadow: [
      "0 40px 100px rgba(11,59,46,0.3)", "0 12px 32px rgba(11,59,46,0.12)",
      "inset 0 1px 0 rgba(255,255,255,0.95)", "inset 0 -1px 0 rgba(46,139,87,0.15)",
    ].join(", "),
  ...
  accountModalDesc: { fontSize: 13, color: C.textSoft, lineHeight: 1.6, margin: "0 0 24px" },
  formGroup: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 16 },
  formLabel: { fontSize: 12, fontWeight: 800, color: C.forest, letterSpacing: 0.4 },
  formInput: {
    width: "100%", boxSizing: "border-box", padding: "13px 15px", borderRadius: 12,
    border: "1px solid rgba(46,139,87,0.22)", outline: "none",
    background: "rgba(255,255,255,0.68)", color: C.deep,
    fontFamily: "'Rajdhani',sans-serif", fontSize: 14, fontWeight: 700,
    boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9)",
  },
  formInputDisabled: { opacity: 0.75, cursor: "not-allowed", background: "rgba(200,242,220,0.35)" },
  accountCancelBtn: {
    padding: "14px 36px", borderRadius: 999,
    border: "1px solid rgba(255,255,255,0.8)",
    background: "linear-gradient(135deg, rgba(255,255,255,0.7), rgba(200,242,220,0.5))",
    color: C.forest, fontFamily: "'Rajdhani',sans-serif", fontSize: 15, fontWeight: 700,
    cursor: "pointer",
  ...
  modalOverlay: {
    ...
    display: "flex", alignItems: "center", justifyContent: "center",
    padding: "40px 20px", animation: "modalFadeIn 0.3s ease-out",
  },
  modalCard: {
    position: "relative", width: "100%", maxWidth: 680, maxHeight: "85vh",
    overflowY: "auto", padding: "40px 44px 32px", borderRadius: 32,
    background: "linear-gradient(155deg, rgba(255,255,255,0.82) 0%, rgba(255,255,255,0.55) 50%, rgba(200,242,220,0.4) 100%)",
    backdropFilter: "blur(40px) saturate(200%)",
    WebkitBackdropFilter: "blur(40px) saturate(200%)",
    border: "1px solid rgba(255,255,255,0.85)",
    boxShadow: [
  ...
  modalClose: {
    position: "absolute", top: 18, right: 22, width: 36, height: 36,
    borderRadius: 10, border: "1px solid rgba(255,255,255,0.7)",
    background: "linear-gradient(135deg, rgba(255,255,255,0.6), rgba(255,255,255,0.3))",
    color: C.textSoft, fontSize: 16, fontWeight: 600, cursor: "pointer",
    display: "flex", alignItems: "center", justifyContent: "center",
    boxShadow: "0 2px 8px rgba(11,59,46,0.06)", transition: "all 0.2s",
  },
  modalHeader: {
  ...
  modalBadge: {
    ...
    background: "linear-gradient(135deg, rgba(200,242,220,0.9), rgba(127,227,181,0.5))",
    border: "1px solid rgba(255,255,255,0.8)",
    color: C.forest, fontSize: 11, fontWeight: 700, letterSpacing: 1,
    marginBottom: 14, boxShadow: "0 2px 8px rgba(46,139,87,0.15)",
  },
  modalBadgeDot: {
  ...
  modalTitle: {
    fontFamily: "'Chakra Petch',sans-serif", fontSize: 24, fontWeight: 700,
    color: C.deep, margin: 0, letterSpacing: -0.5, lineHeight: 1.3,
  },
  ...
  modalSectionLabel: {
    fontSize: 15, fontWeight: 800, color: C.deep, marginBottom: 12,
    fontFamily: "'Chakra Petch',sans-serif",
  },
  modalText: { fontSize: 14, color: C.text, lineHeight: 1.8, margin: 0 },
  modalSegmentList: { display: "flex", flexDirection: "column", gap: 10 },
  modalSegment: {
  ...
  modalSegmentTime: { fontSize: 13, color: C.emerald, fontWeight: 700 },
  modalSegmentDesc: { fontSize: 13, color: C.text, lineHeight: 1.7, margin: 0 },
  modalDiffList: {
    listStyle: "none", padding: 0, margin: 0,
    display: "flex", flexDirection: "column", gap: 8,
  },
  modalDiffItem: { fontSize: 14, color: C.text, display: "flex", gap: 10, lineHeight: 1.7 },
  modalDiffBullet: { color: C.emerald, fontWeight: 700, flexShrink: 0 },
  modalFooter: {
    display: "flex", justifyContent: "center", gap: 14, marginTop: 28,
    paddingTop: 20, borderTop: "1px solid rgba(46,139,87,0.12)",
  },
  modalCloseBtn: {
